        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    totalDateWallet = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    dateWallet = table.Column<DateTime>(type: "datetime2", nullable: true),
                    userID = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    amountHour = table.Column<float>(type: "real", nullable: true),
                    bookingID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    checkingAt = table.Column<int>(type: "int", nullable: true),
                    bookingDetailID = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckingStaffs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CheckingStaffs_BookingDetails_bookingDetailID",
                        column: x => x.bookingDetailID,
                        principalTable: "BookingDetails",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CheckingStaffs_Users_customerID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckingStaffs_bookingDetailID",
                table: "CheckingStaffs",
                column: "bookingDetailID",
                unique: true,
                filter: "[bookingDetailID] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CheckingStaffs_customerID",
                table: "CheckingStaffs",
                column: "customerID");

            migrationBuilder.CreateIndex(
                name: "IX_Courts_StoreID",
                table: "Courts",
                column: "StoreID");
